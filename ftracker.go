...
const (
	swimmingCaloriesMeanSpeedShift   = float64(1.1) // среднее количество сжигаемых колорий при плавании относительно скорости.
	swimmingCaloriesWeightMultiplier = float64(2)   // множитель веса при плавании.
)
